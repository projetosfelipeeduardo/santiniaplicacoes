...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6 text-center">
                <h3 id="lbl2" class="">Adicionar Comprovantes</h3>
                ...
                @if ($ativado == 1)
                    <button data-toggle="modal" data-target="#modal-doc" class="btn btn-principal text-light mt-2">Enviar
                        Anexo</button>
                @endif
            ...
            {{-- Comentado - ABA sobre envio de PDF --}}
            {{-- <div class="col-md-6 text-center">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-7" style="padding:5%;">
                                        ...
                                        <input class="form-control" placeholder="Nome da imagem" type="text"
                                            id="nome-imagem" name="nome_imagem">
