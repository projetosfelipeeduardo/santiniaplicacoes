...
Route::group(['prefix' => 'cupom'], function () {
    ...
    Route::post('/cupom/finalizar/{id}', 'Cupom\CupomController@finalizar')->name('cupom.finalizar');
});
//});
...
Route::middleware('auth')->group(function () {
    Route::group(['prefix' => 'servicos'], function () {
        ...
        // #FP Adicionado rota pra exclusão do usuario
        Route::post('/usuarios/remove', 'Usuarios\UsuariosController@removeUser')->name('usuarios.remove');
        Route::post('/usuarios/ativar', 'Usuarios\UsuariosController@updateStatus')->name('usuarios.ativar');
    });
    Route::get('/relatorios', 'Report\ReportController@Index')->name('relatorios.index');
    Route::get('/relatorios/gerar-pdf', 'Report\ReportController@gerarRelatorio')->name('relatorios.gerar');
    Route::get('/relatorios/gerar-excel', 'Report\ReportController@exportarRelatorio')->name('relatorios.exportar');
    Route::get('/relatorios/download', 'Report\ReportController@downloadPDF')->name('relatorios.download');
});
